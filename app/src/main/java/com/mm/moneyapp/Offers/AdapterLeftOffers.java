...
public class AdapterLeftOffers extends RecyclerView.Adapter<AdapterLeftOffers.MyViewHolder> {

    private Context acontext;
    private ArrayList<WorkerJobs> arrayList;

    public AdapterLeftOffers(Context context, ArrayList<WorkerJobs> arrayList) {
        this.arrayList = arrayList;
        acontext = context;
    }

    @Override
    public AdapterLeftOffers.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_item_left_offer, parent, false);
